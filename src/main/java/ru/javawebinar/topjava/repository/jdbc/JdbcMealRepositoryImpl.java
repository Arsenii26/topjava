...
public class JdbcMealRepositoryImpl implements MealRepository {
        ...
        MapSqlParameterSource mapSqlParameterSource = new MapSqlParameterSource()
                ...
                if (meal.isNew()){
                    ...
                    meal.setId(newKey.intValue());
                        ...
                        "UPDATE meals SET dateTime=:dateTime, description=:description, calories=:calories WHERE id=:id", mapSqlParameterSource) == 0) {
                    return null;
                }
    ...
    public List<Meal> getBetween(LocalDateTime startDate, LocalDateTime endDate, int userId) {
        return jdbcTemplate.query("SELECT * FROM meals WHERE datetime BETWEEN 'startDate' AND 'endDate'", ROW_MAPPER);
    }
}
